...
module for `rememberMealPhotoResolver` and the shared `HeartIcon` and `CloseIcon`, because both
screens render the same meal photos. Prefer promoting anything more substantial into `core:design-system` or
